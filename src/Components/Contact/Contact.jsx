    ...
    <div className="bg-gray-300 min-h-screen flex flex-col align-middle justify-center ">
      <div className="flex flex-col align-middle justify-center items-center max-w-4xl mx-auto p-4">
        ...
        <div
          ...
          <p className="text-xl font-normal"><a href="">Email: <strong>amitkumarmahapatra2@gmail.com</strong></a></p>
        </div>
        <div
          data-aos="fade-right"
          data-aos-delay="200"
          ...
          <p className="text-xl font-normal"><a href="">Address: <strong>At-Kalidaspur,Balasore,Odisha,India</strong>
          </a></p>
        </div>
        <div
